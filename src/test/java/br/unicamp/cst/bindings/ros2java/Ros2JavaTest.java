...
public class Ros2JavaTest {
    ...
    public void testRos2Topics() throws InterruptedException {
        ...
        RosTopicSubscriberCodelet<StringMessage> subscriber = new RosTopicSubscriberCodelet<>("chatter","chatter", StringMessage.class) {
        ...
        RosTopicPublisherCodelet<StringMessage> publisher = new RosTopicPublisherCodelet<>("chatter", "chatter", StringMessage.class) {
            @Override
